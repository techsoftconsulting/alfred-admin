...
import useFindUsers from '@modules/user/application/use-find-users';
import useRemoveUser from '@modules/user/application/use-remove-user';
...
function UsersList({
    ...
    const { data: roles } = useFindUserRoles();
                        ...
                        users?.map((r) => {
                            return (
                                <TableRow key={r.id}>
                                    ...
                                    <TableCell>
                                        <Text>{(roles ?? []).find((i) => i.id === r.roleId)?.name}</Text>
                                    </TableCell>
...
function RowOptions({
    ...
    return (
        ...
        >
            ...
            {(identity?.id !== entity.id && check('DELETE_USERS_AND_ROLES')) && (
                <IconButton
                    onPress={() => {
                        onDelete();
                    }}
